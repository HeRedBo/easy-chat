...
const file_user_proto_rawDesc = "" +
	...
	"\fFindUserResp\x12$\n" +
	"\x04user\x18\x01 \x03(\v2\x10.user.UserEntityR\x04user2\xf8\x01\n" +
	"\x04User\x12%\n" +
	"\x04Ping\x12\r.user.Request\x1a\x0e.user.Response\x12(\n" +
	"\x05Login\x12\x0e.user.LoginReq\x1a\x0f.user.LoginResp\x121\n" +
	"\bRegister\x12\x11.user.RegisterReq\x1a\x12.user.RegisterResp\x129\n" +
	"\vGetUserInfo\x12\x14.user.GetUserInfoReq\x1a\x14.user.GetUserInfoReq\x121\n" +
...
var file_user_proto_depIdxs = []int32{
	...
	7,  // 10: user.User.GetUserInfo:output_type -> user.GetUserInfoReq
