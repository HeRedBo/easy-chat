...
type UserClient interface {
	...
	GetUserInfo(ctx context.Context, in *GetUserInfoReq, opts ...grpc.CallOption) (*GetUserInfoReq, error)
...
func (c *userClient) GetUserInfo(ctx context.Context, in *GetUserInfoReq, opts ...grpc.CallOption) (*GetUserInfoReq, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServer interface {
	...
	GetUserInfo(context.Context, *GetUserInfoReq) (*GetUserInfoReq, error)
...
func (UnimplementedUserServer) GetUserInfo(context.Context, *GetUserInfoReq) (*GetUserInfoReq, error) {
