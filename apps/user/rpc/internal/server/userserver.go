...
import (
	...
	"github.com/HeRedBo/easy-chat/apps/user/rpc/internal/logic"
...
func (s *UserServer) GetUserInfo(ctx context.Context, in *user.GetUserInfoReq) (*user.GetUserInfoReq, error) {
